...
namespace BSM {
    ...
    public partial class databaseDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UserRow AddUserRow(string 账号, string 密码, string 昵称) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UserRow FindBy账号(string 账号) {
        ...
        public partial class UserRow : global::System.Data.DataRow {
            ...
            public string 账号 {
                get {
                    return ((string)(this[this.tableUser.账号Column]));
                }
                set {
                    this[this.tableUser.账号Column] = value;
                }
            }
            ...
            public string 昵称 {
                get {
                    try {
                        return ((string)(this[this.tableUser.昵称Column]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("表“User”中列“昵称”的值为 DBNull。", e);
                    }
                }
                set {
                    this[this.tableUser.昵称Column] = value;
                }
            }
            ...
            public bool Is昵称Null() {
                return this.IsNull(this.tableUser.昵称Column);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void Set昵称Null() {
                this[this.tableUser.昵称Column] = global::System.Convert.DBNull;
            }
        }
...
namespace BSM.databaseDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[User] WHERE (([账号] = @Original_账号) AND ((@IsNull_密码 = 1 AND [密" +
                "码] IS NULL) OR ([密码] = @Original_密码)) AND ((@IsNull_昵称 = 1 AND [昵称] IS NULL) OR " +
                "([昵称] = @Original_昵称)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([账号], [密码], [昵称]) VALUES (@账号, @密码, @昵称);\r\nSELECT 账号, 密" +
                "码, 昵称 FROM [User] WHERE (账号 = @账号)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [账号] = @账号, [密码] = @密码, [昵称] = @昵称 WHERE (([账号] = @Original_账号) AND ((@IsNull_密码 = 1 AND [密码] IS NULL) OR ([密码] = @Original_密码)) AND ((@IsNull_昵称 = 1 AND [昵称] IS NULL) OR ([昵称] = @Original_昵称)));
SELECT 账号, 密码, 昵称 FROM [User] WHERE (账号 = @账号)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BSM.Properties.Settings.Default.databaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT 账号, 密码, 昵称 FROM dbo.[User]";
        ...
        public virtual int Delete(string Original_账号, string Original_密码, string Original_昵称) {
            if ((Original_账号 == null)) {
        ...
        public virtual int Insert(string 账号, string 密码, string 昵称) {
            if ((账号 == null)) {
        ...
        public virtual int Update(string 账号, string 密码, string 昵称, string Original_账号, string Original_密码, string Original_昵称) {
            if ((账号 == null)) {
                throw new global::System.ArgumentNullException("账号");
            }
            else {
            ...
            if ((Original_账号 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_账号));
            }
            if ((Original_密码 == null)) {
            ...
            if ((Original_昵称 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_昵称));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string 密码, string 昵称, string Original_账号, string Original_密码, string Original_昵称) {
            return this.Update(Original_账号, 密码, 昵称, Original_账号, Original_密码, Original_昵称);
        }
    }
